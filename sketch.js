...
function setup() {
  ...
  fantasma.scale = 0.3;
  fantasma.addImage("fantasma", imageFantasma);
}
...
function draw() {
  ...
  if(grupoBloco.isTouching(Fantasma) || fantasma.y > 600){
    estado = "ENCERRAR";
}
 gerarPortas();
}
  ...
  function gerarPortas(){
   if (frameCount % 240 === 0){
    ...
    porta.addImage("porta", imagePorta);
    ...
    grupodeBloco.add(blocoinvisivel);
  }
}
